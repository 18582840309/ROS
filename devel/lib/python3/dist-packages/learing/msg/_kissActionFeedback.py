...
"""autogenerated by genpy from learing/kissActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class kissActionFeedback(genpy.Message):
  _md5sum = "0111b7638e2ca343e15287845bda124f"
  _type = "learing/kissActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','learing/kissFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(kissActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = learing.msg.kissFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = learing.msg.kissFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.kiss_complete
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.kiss_complete,) = _get_struct_f().unpack(str[start:end])
      return self

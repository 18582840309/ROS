...
"""autogenerated by genpy from learing/kissActionResult.msg. Do not edit."""
import codecs
import sys
...
class kissActionResult(genpy.Message):
  _md5sum = "c45c9aa3589522ff5a5b56ed668e17f6"
  _type = "learing/kissActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','learing/kissResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(kissActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = learing.msg.kissResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = learing.msg.kissResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.result.total_kiss_kissed
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.total_kiss_kissed,) = _get_struct_I().unpack(str[start:end])
      return self
